...
function updateQuestionFields(questionNumber) {
  ...
  if (questionType === 'multiple_choice') {
    questionFields.innerHTML = `
      ...
      <input class="inputbox" type="text" id="o1${questionNumber}" name="o1${questionNumber}" placeholder="Enter option A" minlength="2" maxlength="100" required /></br>
      <label for="o2${questionNumber}">Option B:</label><br>
      <input class="inputbox" type="text" id="o2${questionNumber}" name="o2${questionNumber}" placeholder="Enter option B" minlength="2" maxlength="100" required /></br>
      <label for="o3${questionNumber}">Option C:</label><br>
      <input class="inputbox" type="text" id="o3${questionNumber}" name="o3${questionNumber}" placeholder="Enter option C" minlength="2" maxlength="100" required /></br>
      <label for="o4${questionNumber}">Option D:</label><br>
      <input class="inputbox" type="text" id="o4${questionNumber}" name="o4${questionNumber}" placeholder="Enter option D" minlength="2" maxlength="100" required /></br>
      <label for="a${questionNumber}">Correct option:</label><br>
      <input class="inputbox" type="text" id="a${questionNumber}" name="a${questionNumber}" placeholder="Enter more than one correct answer separated by a comma" minlength="2" maxlength="100" required /></br>
    `;
  }
    ...
    questionFields.innerHTML = `
      ...
      <input class="inputbox" type="text" id="o4${questionNumber}" name="o4${questionNumber}" placeholder="Enter option D" minlength="2" maxlength="100" required /></br>
      <label for="a${questionNumber}">Correct option:</label><br>
      <input class="inputbox" type="text" id="a${questionNumber}" name="a${questionNumber}" placeholder="Enter the correct option" minlength="2" maxlength="100" required /></br>
    `;
  } 
}

// Initialize the fields for the first question
updateQuestionFields(1);
</script>
